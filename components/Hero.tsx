export function Hero() {
  return (
    <section className="relative flex min-h-screen flex-col justify-center items-center text-center px-8 pt-24 pb-16 overflow-hidden z-[1]">
      {/* Layered background for depth (parallax-style) */}
      <div className="hero-bg-layer hero-bg-layer-gradient" aria-hidden />
      <div className="hero-bg-layer hero-bg-layer-fixed hero-shimmer" aria-hidden />
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-wrap gap-3 justify-center mt-10 animate-[fadeUp_0.8s_ease_0.3s_both]">
          <span className="font-mono text-[0.7rem] tracking-wider uppercase py-2 px-4 rounded-full border border-oxford-border text-oxford-text-dim bg-oxford-surface shadow-card hover:shadow-card-hover hover:scale-[1.02] transition-all duration-300">
            sCO₂ Brayton
          </span>
          <span className="font-mono text-[0.7rem] tracking-wider uppercase py-2 px-4 rounded-full border border-oxford-border text-oxford-text-dim bg-oxford-surface shadow-card hover:shadow-card-hover hover:scale-[1.02] transition-all duration-300">
            MOF DAC
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5 text-oxford-text-dim font-mono text-[0.65rem] tracking-widest animate-[fadeUp_1s_ease_0.6s_both] z-10">
